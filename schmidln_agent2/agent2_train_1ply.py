...
# =============================================================================
# 2-ply training option
# =============================================================================
    # -------------------------------------------------------------------------
    # OPTIONAL 2-PLY SEARCH METHODS
    # These methods are available for training with 2-ply search if desired.
    # However, 2-ply training is ~100x slower than 1-ply (~0.01 vs 1.4 games/sec).
    # We trained with 1-ply for speed, then evaluated with 2-ply (in agent2_eval_2ply.py).
    # To enable 2-ply training, use the --use-2ply flag when running this script.
    # -------------------------------------------------------------------------
